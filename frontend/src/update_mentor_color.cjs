            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
              ...
              <div className="xl:col-span-4 space-y-8">
                ...
                {(() => {
                  ...
                  return (
                    <div className="group relative overflow-hidden rounded-2xl bg-white border-t-[6px] border-t-amber-500 border-l border-r border-b border-slate-200 p-7 transition-all duration-300 shadow-xl shadow-slate-200/80 hover:shadow-2xl hover:shadow-amber-500/20 hover:-translate-y-1">
                      <div className="absolute top-0 right-0 p-4 opacity-[0.04] group-hover:opacity-[0.08] group-hover:scale-110 transition-all duration-500">
                        <Award className="w-24 h-24 text-amber-500" />
                      </div>
                      <div className="relative z-10">
                        <div className="flex items-center space-x-4 mb-8">
                          <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-amber-400 to-orange-500 flex items-center justify-center text-white font-extrabold text-2xl shadow-lg shadow-orange-500/30">
                            {mentor ? mentor.name.charAt(0) : '?'}
                          </div>
                          <div>
                            <p className="text-[10px] text-amber-600 uppercase tracking-widest font-black mb-1">Assigned Mentor</p>
                        ...
                        {mentor ? (
                          <div className="space-y-4">
                            <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 transition-colors group-hover:bg-amber-50/50 group-hover:border-amber-200/60">
                            ...
                            <div className="bg-amber-50/80 rounded-xl p-4 border border-amber-200/70 transition-colors group-hover:bg-amber-100/80">
                              <p className="text-[10px] text-amber-600 uppercase tracking-widest font-black mb-1 flex items-center gap-1.5"><Briefcase className="w-3 h-3" /> Placement Detail</p>
                              <p className="text-sm text-amber-900 font-black">{mentor.placement}</p>
                            </div>
                          </div>
                        ) : (
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    console.log('Successfully updated Mentor card color.');
} else {
